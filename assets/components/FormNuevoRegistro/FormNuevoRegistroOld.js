...
function FormSiniestros(props) {
    const {credentials, localidades, transportistas, rutas, plantas, areas, proveedores, tipos, descripciones} = props;
    ...
    return (
        <form className="formSiniestros" noValidate autoComplete="off">
            ...
            <div className="row">
                <div className="column">
                <FormControl variant="outlined" className="textField" size="small">
                        <InputLabel htmlFor="outlined-estatus">Proveedor</InputLabel>
                        <Select
                            labelId="outlined-estatus"
                            id="Proveedor"
                            label="Proveedor"
                          ...
                          >
                          {(!!proveedores) ? proveedores.map((prov) => (   <MenuItem value={prov.proveedor}>{prov.proveedor}</MenuItem>  ) ): ('')}
                        </Select>
                    </FormControl>
                    ...
                    <div className="column">
                        <MuiPickersUtilsProvider utils={DateFnsUtils} locale={esLocale}>
                            <KeyboardDatePicker
                                ...
                                InputAdornmentProps={{ position: "start" }}
                                value={fechaCheque}
                                onChange={(value) => {setFechaCheque(value)}}
                            />
                        </MuiPickersUtilsProvider>
                    </div>
                    <div className="column">
